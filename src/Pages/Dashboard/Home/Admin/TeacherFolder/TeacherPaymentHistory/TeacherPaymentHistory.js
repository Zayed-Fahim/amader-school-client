...
const TeacherPaymentHistory = () => {
  ...
  return (
    <div className="overflow-y-hidden overflow-x-hidden min-h-screen">
      <div className="relative xl:top-28 xl:left-[320px] z-[1] w-[81.5%] bg-white max-h-max">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    {teachers?.map((teacher) => (
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                          {teacher?.salary?.amounts?.slice(-1)}
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                          <button
                            type="submit"
                            className={`${
                              teacher?.salary?.statuses?.slice(-1) === "paid"
                                ? "bg-green-600 text-white h-7 w-[4.5rem] text-center font-bold rounded-xl uppercase disabled cursor-default"
                                : "bg-red-600 text-white h-7 w-[4.5rem] text-center font-bold rounded-xl uppercase"
                            }`}
                          >
                            {teacher?.salary?.statuses?.slice(-1)}
                          </button>
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                          {teacher?.salary?.issueDates?.slice(-1)}
                        </td>
                      </tr>
                    ))}
                  </tbody>
