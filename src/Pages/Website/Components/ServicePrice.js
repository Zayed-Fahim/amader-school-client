      ...
      <div className="flex flex-wrap md:flex-wrap lg:flex-nowrap xl:flex-nowrap lg:gap-8 md:gap-8  gap-5 justify-center items-center xl:gap-10">
        {plans.map((plan, i) => {
          return (
            <div
              key={i}
              className="w-full h-[400px] md:h-[440px] md:w-[340px] lg:h-[480px] lg:w-[350px] xl:h-[500px] xl:w-[400px] mx-5 xl:mx-0 md:mx-0 lg:mx-0 bg-white hover:shadow-sm hover:shadow-[#ffbe15] lg:hover:scale-105 xl:hover:scale-105 drop-shadow-lg rounded-md"
            >
              ...
              <div className="h-[260px] md:h-[300px] lg:h-[320px] xl:h-[340px] xl:w-[400px] grid justify-center items-center text-black">
                ...
                <h1 className="text-[#ffbe15] text-4xl md:text-5xl lg:text-6xl xl:text-6xl">
                  {plan.amount}
                </h1>
